const DATA = [
    {
    id: 1,
    title: "Fjallraven - Foldsack No. 1 , Fits 15 Laptops",
    price: 109.95,
   ...
   img: "https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg",
    ...
    {
    id: 3,
    title: "Mens Cotton Jacket with leadhar",
    price: 55.99,
   ...
   img: "https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg",
    ...
    {
    id: 4,
    title: "Mens Casual Slim Fit tshirt",
    price: 15.99,
    desc: "The color could be slightly different between on the screen and in practice. / Please note that body builds vary by person, therefore, detailed size information should be reviewed below on the product desc.",
    category: "men's clothing",
   img: "https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg",
    ...
    {
    id: 5,
    title: "John Hardy Women's Station Chain Bracelet",
    price: 695,
   ...
   img: "https://fakestoreapi.com/img/71YAIFU48IL._AC_UL640_QL65_ML3_.jpg",
    ...
    {
    id: 8,
    title: "Pierced Owl Rose Gold  Stainless Steel Double",
    price: 10.99,
   ...
   img: "https://fakestoreapi.com/img/51UDEzMJVpL._AC_UL640_QL65_ML3_.jpg",
    ...
    {
    id: 9,
    title: "WD 2TB Elements Portable  Hard Drive - USB 3.0 ",
    price: 64,
   ...
   img: "https://fakestoreapi.com/img/71kWymZ+c+L._AC_SX679_.jpg",
    ...
    {
    id: 12,
    title: "WD 4TB Gaming Drive Works 4 Portable External Hard Drive",
    price: 114,
   ...
   img: "https://fakestoreapi.com/img/61mtL65D4cL._AC_SX679_.jpg",
    ...
    {
    id: 13,
    title: "Acer SB220Q bi 21.5 inches HD (1920 x 1080) IPS Ultra-Thin",
    price: 599,
   ...
   img: "https://fakestoreapi.com/img/81QpkIctqPL._AC_SX679_.jpg",
    ...
    {
    id: 14,
    title: "Samsung 49-Inch CHG90 144Hz Monitor Super Ultrawide QLED ",
    price: 999.99,
   ...
   img: "https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_.jpg",
    ...
    {
    id: 16,
    title: "Lock and Love Women's Removable Leather Moto Biker Jacket",
    price: 29.95,
   ...
   img: "https://fakestoreapi.com/img/81XH0e8fefL._AC_UY879_.jpg",
    ...
    {
    id: 17,
    title: "Rain Jacket Women Climbing Raincoats",
    price: 39.99,
